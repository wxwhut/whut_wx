...
INSERT INTO `user` VALUES (1,'admin','admin','0','admin','admin'),(2,'zc','123456','0','505724935@qq.com','15271835172'),(3,'张聪','123456','1','505724935@qq.com','15271835172');
...
CREATE TABLE `child` (
  `id` int(20) AUTO_INCREMENT COMMENT 'ID' ,
   ...
   `parentid` varchar(255) DEFAULT NULL COMMENT '抚养人ID',
...
INSERT INTO `vaccine` VALUES (1,'水痘疫苗','2017-01-01','2018-01-01',160.00,'水痘疫苗是经水痘病毒传代毒株制备而成，是预防水痘感染的唯一手段。接种水痘疫苗不仅能预防水痘，还能预防因水痘带状疱疹而引起的并发症。',0);
INSERT INTO `vaccine` VALUES (2,'乙肝疫苗','2017-02-01','2018-04-01',100.00,'乙肝疫苗是一种预防乙型肝炎的疫苗。即从乙型肝炎病毒携带者血浆中分离乙肝表面抗原(HbsAg)，经处理后而制成。乙肝疫苗接种后，可刺激免疫系统产生保护性抗体，这种抗体存在于人的体液之中，乙肝病毒一旦出现，抗体会立即作用，将其清除，阻止感染，并不会伤害肝脏，从而使人体具有了预防乙肝的免疫力。因此乙肝疫苗成为生活中不可缺少的一把保护伞。 预防一般至少可持续12年，因此，一般人群不需要进行抗-HBs监测或加强免疫。但对高危人群可进行抗-HBs监测，如抗-HBs<10mIU/ml，可给予加强免疫。',0);
